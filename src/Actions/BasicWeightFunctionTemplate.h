...
#ifndef SRC_ACTIONS_BASICWEIGHTFUNCTIONTEMPLATE_H_
#define SRC_ACTIONS_BASICWEIGHTFUNCTIONTEMPLATE_H_
...
template <class FieldType> class BasicWeightFunctionTemplate : public BasicWeightFunction {
public:
	BasicWeightFunctionTemplate( const FieldType& boolField, size_t timeSize, size_t spatialSize, size_t dim, size_t numFlavours, double coupling ) :
		kfield( boolField ),
		initialField( kfield ),
		savedState( kfield ),
...
#endif /* SRC_ACTIONS_BASICWEIGHTFUNCTIONTEMPLATE_H_ */
